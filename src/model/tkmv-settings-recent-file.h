...
TkmvSettingsRecentFile *tkmv_settings_recent_file_new (const gchar *name, const gchar *path);
TkmvSettingsRecentFile *tkmv_settings_recent_file_ref (TkmvSettingsRecentFile *rf);
void tkmv_settings_recent_file_unref (TkmvSettingsRecentFile *rf);
void tkmv_settings_recent_file_set_index (TkmvSettingsRecentFile *rf, guint idx);
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC (TkmvSettingsRecentFile, tkmv_settings_recent_file_unref);
